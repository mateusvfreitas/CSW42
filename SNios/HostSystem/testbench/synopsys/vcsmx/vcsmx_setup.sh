...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/HostSystem_aval1_avalon_slave_0_translator_avalon_universal_slave_0_agent_rsp_fifo.vho" -work aval1_avalon_slave_0_translator_avalon_universal_slave_0_agent_rsp_fifo
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/contador0.vhd"                                                                          -work aval1                                                                  
  vhdlan -xlrm "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/contador1.vhd"                                                                          -work aval1                                                                  
  vhdlan -xlrm "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/contador8bit.vhd"                                                                       -work aval1                                                                  
  vhdlan -xlrm "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/reg32.vhd"                                                                              -work aval1                                                                  
  vhdlan -xlrm "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/reg32_avalon_interface.vhd"                                                             -work aval1                                                                  
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/hostsystem_aval1_avalon_slave_0_translator.vhd"                                         -work HostSystem_inst                                                        
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/hostsystem_aval1_avalon_slave_0_translator_avalon_universal_slave_0_agent.vhd"          -work HostSystem_inst                                                        
