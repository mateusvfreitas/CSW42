...
alias com {
  ...
  vlog -sv "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/mentor/altera_merlin_width_adapter.sv"                                                  -work width_adapter                                                          
  vlog -sv "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/mentor/altera_merlin_address_alignment.sv"                                              -work width_adapter                                                          
  vlog -sv "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/mentor/altera_merlin_burst_uncompressor.sv"                                             -work width_adapter                                                          
  ...
  vlog     "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/mentor/altera_reset_controller.v"                                                       -work rst_controller                                                         
  vlog     "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/mentor/altera_reset_synchronizer.v"                                                     -work rst_controller                                                         
  ...
  vcom     "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/HostSystem_aval1_avalon_slave_0_translator_avalon_universal_slave_0_agent_rsp_fifo.vho" -work aval1_avalon_slave_0_translator_avalon_universal_slave_0_agent_rsp_fifo
  ...
  vlog -sv "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/mentor/altera_merlin_slave_agent.sv"                                                    -work memory_s1_translator_avalon_universal_slave_0_agent                    
  vlog -sv "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/mentor/altera_merlin_burst_uncompressor.sv"                                             -work memory_s1_translator_avalon_universal_slave_0_agent                    
  vlog -sv "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/mentor/altera_merlin_master_agent.sv"                                                   -work cpu_instruction_master_translator_avalon_universal_master_0_agent      
  vlog -sv "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/mentor/altera_merlin_slave_translator.sv"                                               -work memory_s1_translator                                                   
  vlog -sv "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/mentor/altera_merlin_master_translator.sv"                                              -work cpu_instruction_master_translator                                      
  vcom     "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/contador0.vhd"                                                                          -work aval1                                                                  
  vcom     "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/contador1.vhd"                                                                          -work aval1                                                                  
  vcom     "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/contador8bit.vhd"                                                                       -work aval1                                                                  
  vcom     "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/reg32.vhd"                                                                              -work aval1                                                                  
  vcom     "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/reg32_avalon_interface.vhd"                                                             -work aval1                                                                  
  ...
  vcom     "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/hostsystem_aval1_avalon_slave_0_translator.vhd"                                         -work HostSystem_inst                                                        
  ...
  vcom     "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/hostsystem_aval1_avalon_slave_0_translator_avalon_universal_slave_0_agent.vhd"          -work HostSystem_inst                                                        
